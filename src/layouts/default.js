...
apply_theme() {
    ...
    # panes
    pane_border_fg="${colorSet.shade3}"
    pane_active_border_fg="${colorSet[`accent${i * 2}`]}"
    ...
    session_fg="${colorSet.shade3}"
    session_bg="${colorSet.shade1}"
    ...
    window_status_fg="${colorSet.shade7}"
    window_status_bg="${colorSet.shade1}"
    ...
    window_status_current_fg="${colorSet.shade2}"
    window_status_current_bg="${colorSet[`accent${i * 2}`]}"
    ...
    window_status_activity_fg="${colorSet.shade6}"
    window_status_activity_bg="${colorSet.shade1}"
    ...
    window_status_bell_fg="${colorSet[`accent${i * 2}`]}"
    ...
    window_status_last_fg="${colorSet[`accent${i * 2}`]}"
